<!-- 
  ...
  1. Load ../adapters/glances.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/glances.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + glances.js + StatusCard.vue
export default {
  name: 'Glances',
  props: {
    item: Object,
