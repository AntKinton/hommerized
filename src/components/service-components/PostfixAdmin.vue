<!-- 
  ...
  1. Load ../adapters/postfixadmin.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/postfixadmin.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + postfixadmin.js + StatusCard.vue
export default {
  name: 'PostfixAdmin',
  props: {
    item: Object,
