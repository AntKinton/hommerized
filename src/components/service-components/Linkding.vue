<!-- 
  ...
  1. Load ../adapters/linkding.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/linkding.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + linkding.js + StatusCard.vue
export default {
  name: 'Linkding',
  props: {
    item: Object,
