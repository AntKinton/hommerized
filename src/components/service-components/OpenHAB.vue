<!-- 
  ...
  1. Load ../adapters/openhab.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/openhab.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + openhab.js + StatusCard.vue
export default {
  name: 'OpenHAB',
  props: {
    item: Object,
