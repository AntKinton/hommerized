<!-- 
  ...
  1. Load ../adapters/ping.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/ping.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + ping.js + StatusCard.vue
export default {
  name: 'Ping',
  props: {
    item: Object,
