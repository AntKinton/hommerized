<!-- 
  ...
  1. Load ../adapters/olivetin.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/olivetin.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + olivetin.js + StatusCard.vue
export default {
  name: 'Olivetin',
  props: {
    item: Object,
