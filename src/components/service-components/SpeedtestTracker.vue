<!-- 
  ...
  1. Load ../adapters/speedtesttracker.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/speedtesttracker.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + speedtesttracker.js + StatusCard.vue
export default {
