<!-- 
  ...
  1. Load ../adapters/wallabag.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/wallabag.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + wallabag.js + StatusCard.vue
export default {
  name: 'Wallabag',
  props: {
    item: Object,
