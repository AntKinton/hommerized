<!-- 
  ...
  1. Load ../adapters/portainer.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/portainer.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + portainer.js + StatusCard.vue
export default {
  name: 'Portainer',
  props: {
    item: Object,
