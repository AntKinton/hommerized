<!-- 
  ...
  1. Load ../adapters/mealie.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/mealie.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + mealie.js + StatusCard.vue
export default {
  name: 'Mealie',
  props: {
    item: Object,
