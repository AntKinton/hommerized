<!-- 
  ...
  1. Load ../adapters/plex.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/plex.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + plex.js + StatusCard.vue
export default {
  name: 'Plex',
  props: {
    item: Object,
