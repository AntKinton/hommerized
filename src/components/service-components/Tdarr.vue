<!-- 
  ...
  1. Load ../adapters/tdarr.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/tdarr.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + tdarr.js + StatusCard.vue
export default {
  name: 'Tdarr',
  props: {
    item: Object,
