<!-- 
  ...
  1. Load ../adapters/transmission.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/transmission.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + transmission.js + StatusCard.vue
export default {
  name: 'Transmission',
  props: {
    item: Object,
