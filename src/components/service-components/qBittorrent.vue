<!-- 
  ...
  1. Load ../adapters/qbittorrent.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/qbittorrent.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + qbittorrent.js + StatusCard.vue
export default {
  name: 'QBittorrent',
  props: {
    item: Object,
