<!-- 
  ...
  1. Load ../adapters/matrix.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/matrix.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + matrix.js + StatusCard.vue
export default {
  name: 'Matrix',
  props: {
    item: Object,
