<!-- 
  ...
  1. Load ../adapters/wud.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/wud.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + wud.js + StatusCard.vue
export default {
  name: 'WUD',
  props: {
    item: Object,
