<!-- 
  ...
  1. Load ../adapters/postfix.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/postfix.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + postfix.js + StatusCard.vue
export default {
  name: 'Postfix',
  props: {
    item: Object,
