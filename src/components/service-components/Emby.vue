<!-- 
  ...
  1. Load ../adapters/emby.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/emby.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + emby.js + StatusCard.vue
export default {
  name: 'Emby',
  props: {
    item: Object,
