<!-- 
  ...
  1. Load ../adapters/netalertx.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/netalertx.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + netalertx.js + StatusCard.vue
export default {
  name: 'NetAlertx',
  props: {
    item: Object,
