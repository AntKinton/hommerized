<!-- 
  ...
  1. Load ../adapters/peanut.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/peanut.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + peanut.js + StatusCard.vue
export default {
  name: 'PeaNUT',
  props: {
    item: Object,
