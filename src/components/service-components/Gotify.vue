<!-- 
  ...
  1. Load ../adapters/gotify.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/gotify.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + gotify.js + StatusCard.vue
export default {
  name: 'Gotify',
  props: {
    item: Object,
