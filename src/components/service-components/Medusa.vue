<!-- 
  ...
  1. Load ../adapters/medusa.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/medusa.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + medusa.js + StatusCard.vue
export default {
  name: 'Medusa',
  props: {
    item: Object,
