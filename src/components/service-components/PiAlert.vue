<!-- 
  ...
  1. Load ../adapters/pialert.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/pialert.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + pialert.js + StatusCard.vue
export default {
  name: 'PiAlert',
  props: {
    item: Object,
