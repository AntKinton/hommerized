<!-- 
  ...
  1. Load ../adapters/gatus.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/gatus.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + gatus.js + StatusCard.vue
export default {
  name: 'Gatus',
  props: {
    item: Object,
