<!-- 
  ...
  1. Load ../adapters/homeassistant.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/homeassistant.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + homeassistant.js + StatusCard.vue
export default {
  name: 'HomeAssistant',
  props: {
    item: Object,
