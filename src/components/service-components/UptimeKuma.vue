<!-- 
  ...
  1. Load ../adapters/uptimekuma.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/uptimekuma.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + uptimekuma.js + StatusCard.vue
export default {
  name: 'UptimeKuma',
  props: {
    item: Object,
