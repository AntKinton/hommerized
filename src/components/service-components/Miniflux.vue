<!-- 
  ...
  1. Load ../adapters/miniflux.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/miniflux.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + miniflux.js + StatusCard.vue
export default {
  name: 'Miniflux',
  props: {
    item: Object,
