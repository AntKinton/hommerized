<!-- 
  ...
  1. Load ../adapters/sabnzbd.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/sabnzbd.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + sabnzbd.js + StatusCard.vue
export default {
  name: 'SABnzbd',
  props: {
    item: Object,
