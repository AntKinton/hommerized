<!-- 
  ...
  1. Load ../adapters/pihole.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/pihole.js and archetypes/MetricCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + pihole.js + MetricCard.vue
export default {
  name: 'PiHole',
  props: {
    item: Object,
