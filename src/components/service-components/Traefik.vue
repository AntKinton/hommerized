<!-- 
  ...
  1. Load ../adapters/traefik.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/traefik.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + traefik.js + StatusCard.vue
export default {
  name: 'Traefik',
  props: {
    item: Object,
