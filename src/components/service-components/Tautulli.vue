<!-- 
  ...
  1. Load ../adapters/tautulli.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/tautulli.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + tautulli.js + StatusCard.vue
export default {
  name: 'Tautulli',
  props: {
    item: Object,
