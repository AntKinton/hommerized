<!-- 
  ...
  1. Load ../adapters/jellystat.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/jellystat.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + jellystat.js + StatusCard.vue
export default {
  name: 'Jellystat',
  props: {
    item: Object,
