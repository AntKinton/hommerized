<!-- 
  ...
  1. Load ../adapters/nextcloud.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/nextcloud.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + nextcloud.js + StatusCard.vue
export default {
  name: 'Nextcloud',
  props: {
    item: Object,
