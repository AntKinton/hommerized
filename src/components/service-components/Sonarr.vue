<!-- 
  ...
  1. Load ../adapters/sonarr.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/sonarr.js and archetypes/MediaCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + sonarr.js + MediaCard.vue
export default {
  name: 'Sonarr',
  props: {
    item: Object,
