<!-- 
  ...
  1. Load ../adapters/prowlarr.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/prowlarr.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + prowlarr.js + StatusCard.vue
export default {
  name: 'Prowlarr',
  props: {
    item: Object,
