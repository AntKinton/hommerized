<!-- 
  ...
  1. Load ../adapters/dockersocketproxy.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/dockersocketproxy.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + dockersocketproxy.js + StatusCard.vue
export default {
