<!-- 
  ...
  1. Load ../adapters/ufw.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/ufw.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + ufw.js + StatusCard.vue
export default {
  name: 'UFW',
  props: {
    item: Object,
