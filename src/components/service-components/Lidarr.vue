<!-- 
  ...
  1. Load ../adapters/lidarr.js (data mapping logic)
  2. Load MediaCard archetype (visual presentation)
  3. Connect adapter data to archetype UI
-->

<template>
  <!-- This component is now just a configuration wrapper -->
  <!-- All logic moved to adapters/lidarr.js and archetypes/MediaCard.vue -->
</template>

<script>
// This component is now just a placeholder for the new architecture
// The real work is done by Service.vue + lidarr.js + MediaCard.vue
export default {
  name: 'Lidarr',
  props: {
    item: Object,
