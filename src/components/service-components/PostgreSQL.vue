<!-- 
  ...
  1. Load ../adapters/postgresql.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/postgresql.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + postgresql.js + StatusCard.vue
export default {
  name: 'PostgreSQL',
  props: {
    item: Object,
