<!-- 
  ...
  1. Load ../adapters/vaultwarden.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/vaultwarden.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + vaultwarden.js + StatusCard.vue
export default {
  name: 'Vaultwarden',
  props: {
    item: Object,
