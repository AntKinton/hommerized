<!-- 
  ...
  1. Load ../adapters/truenasscale.js (data mapping logic)
...
<template>
  ...
  <!-- All logic moved to adapters/truenasscale.js and archetypes/StatusCard.vue -->
</template>

<script>
// This component is now just a placeholder for new architecture
// The real work is done by Service.vue + truenasscale.js + StatusCard.vue
export default {
  name: 'TruenasScale',
  props: {
    item: Object,
